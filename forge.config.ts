...
const config: ForgeConfig = {
  packagerConfig: {
    ...
    name: 'WiFi-Share Beta',
    executableName: 'WiFi-Share Beta',
    ...
    win32metadata: {
      ...
      OriginalFilename: 'WiFi-Share Beta',
      ProductName: 'WiFi Share Beta',
      InternalName: 'WiFi Share Beta',
    },
